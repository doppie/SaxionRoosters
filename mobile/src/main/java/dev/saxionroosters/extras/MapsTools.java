...
public class MapsTools {
    ...
    public static ArrayList<Location> getEnschedeLocations() {
        ...
        locations.add(new Location("Schierbeek", "S", new LatLng(52.22086, 6.88692)));
        ...
        locations.add(new Location("ITC", "I", new LatLng(52.22368, 6.88574)));
        locations.add(new Location("Stork", "O", new LatLng(52.21995, 6.88826)));
        locations.add(new Location("Hazemeyer", "Q", new LatLng(52.22035, 6.88908)));
        locations.add(new Location("Hofstede Crull", "P", new LatLng(52.21996, 6.88827)));
        locations.add(new Location("Aintsworth", "N", new LatLng(52.22014, 6.88813)));
        locations.add(new Location("Villa Serphos", "V", new LatLng(52.22024, 6.88857)));

        return locations;
    }

    public static boolean isEnschedeLocation(String name) {
        for(Location l : getEnschedeLocations()) {
    ...
    public static boolean isDeventerLocation(String name) {
        for(Location l : getDeventerLocations()) {
            if(l.getAbbr().equals(name.substring(0,1))) return true;
        }
        return false;
    }
    ...
    public static ArrayList<Location> getDeventerLocations() {
        ...
        locations.add(new Location("D", "D", new LatLng(52.25452, 6.16827)));
        locations.add(new Location("C", "C", new LatLng(52.25415, 6.1684)));
        locations.add(new Location("B", "B", new LatLng(52.2544, 6.16832)));
        locations.add(new Location("A", "A", new LatLng(52.25445, 6.16695)));
